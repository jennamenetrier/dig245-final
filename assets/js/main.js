...
document.getElementById("button-3-a").addEventListener("click", function(){
  ...
  if (userAnswer[3]===quizAnswer[3]) {
    document.getElementById("button-3-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-3-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[3]===quizAnswer[3]) {
    document.getElementById("button-3-b").style.backgroundColor="green";
  } else{
...
document.getElementById("button-4-a").addEventListener("click", function(){
   userAnswer.push("a");
  if (userAnswer[4]===quizAnswer[4]) {
    document.getElementById("button-4-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-4-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[4]===quizAnswer[4]) {
    document.getElementById("button-4-b").style.backgroundColor="green";
  } else{
...
document.getElementById("button-5-a").addEventListener("click", function(){
   userAnswer.push("a");
  if (userAnswer[5]===quizAnswer[5]) {
    document.getElementById("button-5-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-5-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[5]===quizAnswer[5]) {
    document.getElementById("button-5-b").style.backgroundColor="green";
  } else{
...
document.getElementById("button-6-a").addEventListener("click", function(){
   userAnswer.push("a");
  if (userAnswer[6]===quizAnswer[6]) {
    document.getElementById("button-6-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-6-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[6]===quizAnswer[6]) {
    document.getElementById("button-6-b").style.backgroundColor="green";
  } else{
...
document.getElementById("button-7-a").addEventListener("click", function(){
   userAnswer.push("a");
  if (userAnswer[7]===quizAnswer[7]) {
    document.getElementById("button-7-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-7-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[7]===quizAnswer[7]) {
    document.getElementById("button-7-b").style.backgroundColor="green";
  } else{
...
document.getElementById("button-8-a").addEventListener("click", function(){
   userAnswer.push("a");
  if (userAnswer[8]===quizAnswer[8]) {
    document.getElementById("button-8-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-8-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[8]===quizAnswer[8]) {
    document.getElementById("button-8-b").style.backgroundColor="green";
  } else{
...
document.getElementById("button-9-a").addEventListener("click", function(){
   userAnswer.push("a");
  if (userAnswer[9]===quizAnswer[9]) {
    document.getElementById("button-9-a").style.backgroundColor="Green";
  } else{
...
document.getElementById("button-9-b").addEventListener("click", function(){
   userAnswer.push("b");
  if (userAnswer[9]===quizAnswer[9]) {
    document.getElementById("button-9-b").style.backgroundColor="green";
  } else{
